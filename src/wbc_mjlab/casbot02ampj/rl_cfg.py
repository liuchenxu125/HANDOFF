"""AMP-PPO runner configuration for the CASBOT02 27-DoF teacher."""
...
def casbot02_ampj_teacher_flat_runner_cfg() -> AmpRunnerCfg:
  """Match the G1 AMP teacher's PPO/discriminator hyperparameters."""
  experiment_name = "casbot02_ampj_teacher_flat"
  return AmpRunnerCfg(
    seed=42,
    ...
    amp_motion_files=str(_AMP_DATA_DIR),
...
__all__ = ["casbot02_ampj_teacher_flat_runner_cfg"]
